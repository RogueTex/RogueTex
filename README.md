...
I also built an [end-to-end agentic pipeline](https://github.com/RogueTex/Document-ML-Agent) for receipt and invoice processing with adaptive ML-based approval logic. On the game side, I wrote a [2048 variant](https://github.com/RogueTex/2A1BGame) from scratch and then built an [RL solver](https://github.com/RogueTex/2A1B_Solver) on top of it.
